...
Pandas has 2 main types : Dataframe And series  

So in the sample CSV (Comma Seperated Values) we have orders.csv  

Pandas makes it a lot easier to work with this data

We can also load in excell spreadsheet  
